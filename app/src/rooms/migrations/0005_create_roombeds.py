...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='room',
            name='members',
            field=models.ManyToManyField(related_name='room_of_user', through='rooms.UserRoom',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True,
                                       ...
                                       related_name='available_beds', to='rooms.RoomBeds'),
        ),
        migrations.AddField(
            model_name='room',
            name='beds',
            field=models.OneToOneField(blank=True, null=True,
                                       on_delete=django.db.models.deletion.CASCADE,
                                       related_name='actual_beds', to='rooms.RoomBeds'),
        ),
    ]
