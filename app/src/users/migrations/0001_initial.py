    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_number', models.TextField(blank=True, default='', help_text='Providing false information risks removal of your application with no refund.')),
                ...
                ('transport', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='passengers', to='conferences.transport')),
