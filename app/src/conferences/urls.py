...
urlpatterns = [
    ...
    re_path(r'^transport/list/students_by_transport/paid$', views.list_csv_paid_students_by_transport,
            name='list_csv_paid_students_by_transport'),
    re_path(r'^transport/list/students_by_transport/not_paid$', views.list_csv_paid_not_students_by_transport,
            name='list_csv_paid_not_students_by_transport'),
