...
urlpatterns = [
    ...
    re_path(r'^bus/list/bus_by_user$', views.list_csv_bus_by_user,
            name='list_csv_bus_by_user'),
    re_path(r'^bus/list/all_users_by_bus$', views.list_csv_all_users_by_bus,
            name='list_csv_all_users_by_bus'),
    re_path(r'^bus/list/paid_users_by_bus$', views.list_csv_paid_users_by_bus,
